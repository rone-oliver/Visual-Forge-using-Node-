import { Document, FilterQuery, InsertManyOptions, ProjectionType, Types, UpdateQuery } from "mongoose";
...
export interface IBaseRepository<T, D extends Document> {
    ...
    findById(id: string | Types.ObjectId, projection?: ProjectionType<T>): Promise<D | null>;
    findOneAndUpdate(filter: FilterQuery<T>, update: UpdateQuery<T>): Promise<D | null>;
