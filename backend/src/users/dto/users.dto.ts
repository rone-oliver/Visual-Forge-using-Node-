...
import {
  ...
  PaymentStatus,
  PaymentMethod,
} from '../../common/transaction/models/transaction.schema';
import {
  QuotationStatus,
  OutputType,
  FileType,
...
export class EditorRequestStatusResponseDto {
  @ApiPropertyOptional({
    description: 'Status of the editor request',
    example: 'Pending',
  })
  @IsString()
  @IsOptional()
...
export class UpdateProfileDto {
  ...
  @ApiPropertyOptional({
    example: 'A full-stack developer with a passion for AI.',
  })
  @IsString()
  @MaxLength(500)
  @IsOptional()
...
export class CreateQuotationDto {
  @ApiProperty({
    ...
    example: 'Logo Design for Startup',
  })
  @IsString()
  @IsNotEmpty()
  @MinLength(5)
  ...
  @ApiProperty({
    description: 'Detailed description of the quotation requirements',
    example: 'Need a modern and minimalist logo...',
  })
  @IsString()
  @IsNotEmpty()
  @MinLength(2)
  ...
  @ApiPropertyOptional({
    description: 'Theme or style preference',
    example: 'Minimalist',
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    ...
    description: 'Files attached to the quotation',
  })
  @IsArray()
...
export class UpdateQuotationDto {
  ...
  @ApiPropertyOptional({
    type: [String],
    description: 'Array of unique file IDs to delete',
  })
  @IsArray()
  @IsString({ each: true })
  @IsOptional()
...
export class QuotationResponseDto extends CreateQuotationDto {
  ...
  @ApiPropertyOptional({
    description: 'Advance amount calculated for the quotation',
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Balance amount calculated for the quotation',
  })
  @IsNumber()
  @IsOptional()
  ...
  @ApiProperty({
    description: 'Indicates if the advance payment has been made',
  })
  @IsBoolean()
  ...
  @ApiPropertyOptional({
    type: Types.ObjectId,
    description: 'Editor ID assigned to the quotation',
  })
  @IsMongoId()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    type: String,
    description: 'Editor name who has got the quotation',
  })
  @IsOptional()
  editor?: string;
  ...
  @ApiPropertyOptional({
    type: Types.ObjectId,
    description: 'Works ID associated with the quotation',
  })
  @IsMongoId()
  @IsOptional()
...
export class QuotationWithBidCountDto extends QuotationResponseDto {
  @ApiPropertyOptional({
    description: 'Number of bids received for this quotation',
  })
  @IsInt()
  @IsOptional()
  bidCount?: number;
...
export class BidResponseDto {
  ...
  @ApiProperty({
    type: Types.ObjectId,
    description: 'Quotation ID for the bid',
  })
  @IsMongoId()
  ...
  @ApiProperty({
    type: Types.ObjectId,
    description: 'Editor ID who placed the bid',
  })
  @IsMongoId()
  editorId: Types.ObjectId;
...
export class SubmitFeedbackDto {
  @ApiProperty({
    ...
    example: 'Great work, but one revision is needed.',
  })
  @IsString()
  @IsNotEmpty()
  @MinLength(10)
...
export class RateEditorDto {
  ...
  @ApiPropertyOptional({
    description: 'Feedback for the editor',
...
export class EditorRatingResponseDto {
  ...
  @ApiProperty({
    description: 'Total number of ratings received by the editor',
  })
  @IsInt()
  totalRatings: number;

  @ApiPropertyOptional({
    description: 'Rating given by the current user, if any',
  })
  @IsOptional()
  @ValidateNested()
...
export class GetCurrentEditorRatingQueryDto {
  @ApiProperty({
    description: 'ID of the editor whose rating is to be fetched',
  })
  @IsMongoId()
  editorId: string;
}
...
export class CreatePaymentDto {
  ...
  @ApiPropertyOptional({
    description: 'Currency for the payment (e.g., INR, USD)',
    example: 'INR',
  })
  @IsString()
  @IsOptional()
...
export class UpdateQuotationPaymentDto {
  @ApiProperty({
    description:
      'Indicates if this is an advance payment or balance payment. True for advance, false for balance.',
  })
  @IsBoolean()
  isAdvancePaid: boolean;
  ...
  @ApiPropertyOptional({
    description: 'Bank associated with the payment',
    required: false,
  })
  @IsString()
  @IsOptional()
  ...
  @ApiPropertyOptional({
    description: 'Wallet associated with the payment',
    required: false,
  })
  @IsString()
  @IsOptional()
...
export class UploadFilesBodyDto {
  @ApiPropertyOptional({
    description: 'Optional folder name to store files in Cloudinary',
  })
  @IsString()
  @IsOptional()
  folder?: string;
...
class QuotationDetailsForTransactionsDto {
  ...
  @ApiProperty({
    ...
    example: 'Logo Design for MyBrand',
  })
  @Expose()
  @IsString()
  title: string;
...
export class TransactionItemDto {
  @ApiProperty({
    ...
    example: '682326516358a4ebb22a055c',
  })
  @Expose()
  _id: Types.ObjectId;
  ...
  @ApiProperty({
    description: 'The type of payment (e.g., advance, balance).',
    example: 'advance',
  })
  @Expose()
  paymentType: PaymentType;
  ...
  @ApiProperty({
    ...
    example: '2025-05-13T11:00:33.490Z',
  })
  @Expose()
  paymentDate: Date;
  ...
  @ApiProperty({
    description: 'The bank used for the payment.',
    required: false,
  })
  @Expose()
  bank?: string;
  ...
  @ApiProperty({
    description: 'The wallet used for the payment.',
    required: false,
  })
  @Expose()
  wallet?: string;
...
export class EditorPublicProfileResponseDto {
  ...
  @ApiProperty({
    description: 'Specialization categories',
    example: ['UI/UX Design', 'Web Development'],
  })
  @IsArray()
  @IsString({ each: true })
  categories: string[];
  ...
  @ApiProperty({
    description: 'A short bio about the editor',
    example: 'Passionate designer and developer.',
  })
  @IsString()
  about: string;

  @ApiProperty({
    description: 'Shared tutorials by the editor',
    isArray: true,
    type: 'string',
    example: ['tutorial_link_1', 'tutorial_link_2'],
  })
  @IsArray()
  @IsOptional()
  @IsString({ each: true })
  ...
  @ApiProperty({
    description: 'Tips and tricks from the editor',
    example: 'Always use version control!',
  })
  @IsString()
  @IsOptional()
...
export class GetPublicEditorsDto {
  @ApiPropertyOptional({
    description: 'Search term for filtering public editors',
  })
  @IsString()
  @IsOptional()
  search?: string;
