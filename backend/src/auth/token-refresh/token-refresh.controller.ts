...
import {
  ...
  ITokenRefreshServiceToken,
} from './interfaces/tokenRefresh-service.interface';

@Controller('auth')
export class TokenRefreshController {
  constructor(
    @Inject(ITokenRefreshServiceToken)
    private readonly _tokenRefreshService: ITokenRefreshService,
  ) {}
